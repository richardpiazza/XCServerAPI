...
public extension XCServerWebAPI {
    ...
    typealias IntegrationCompletion = (_ integration: XCSIntegration?, _ error: Error?) -> Void
    typealias IntegrationsCompletion = (_ integrations: [XCSIntegration]?, _ error: Error?) -> Void
    
    /// Requests the '`/bots/{id}/integrations`' endpoint from the Xcode Server API.
    func integrations(forBotWithIdentifier identifier: String, completion: @escaping IntegrationsCompletion) {
    ...
    func runIntegration(forBotWithIdentifier identifier: String, completion: @escaping IntegrationCompletion) {
    ...
    func integration(withIdentifier identifier: String, completion: @escaping IntegrationCompletion) {
